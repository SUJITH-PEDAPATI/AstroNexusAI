...
# Windows terminals default to cp1252 which cannot encode many Unicode chars
# (e.g. → ═ ─).  Reconfigure stdout/stderr to UTF-8 so print() never crashes.
...
_PROJECT_ROOT = _PROJECT.parent                           # project root (contains backend/)
